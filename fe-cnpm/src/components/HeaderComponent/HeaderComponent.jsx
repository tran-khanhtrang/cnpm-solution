    ...
    <div style={{ heiht: '100%', width: '100%', display: 'flex', background: '#9255FD', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={7} style={{ display: 'flex', alignItems: 'center' }}>
          <WrapperLogo src={logo} alt="logo Thủy Lợi N5" onClick={() => navigate('/about')} style={{ cursor: 'pointer' }} title="Xem thông tin nhóm" />
          <WrapperTextContainer>
            <WrapperTextHeader onClick={() => navigate('/')} style={{ cursor: 'pointer' }}>Thủy Lợi N5</WrapperTextHeader>
