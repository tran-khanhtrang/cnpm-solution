...
| **Người thực hiện** | Trần Khánh Trang (232248749) — Nhóm trưởng |
...
```http
GET http://localhost:3001/api/order/get-details-order/639724669c6dda4fa11edcde
(Headers: không có 'token')
```
...
|---|---|
| **Mã TC** | UAT_02 |
| **URL** | `http://localhost:3000/product-details/:id` |
...
```powershell
Invoke-RestMethod -Uri "http://localhost:3001/api/user/sign-in" `
...
- URL chuyển về `http://localhost:3000/`
...
|---|---|
| **Mã TC** | UAT_06 |
| **URL** | `http://localhost:3000/system/admin` > Tab "Thống kê KPI" |
